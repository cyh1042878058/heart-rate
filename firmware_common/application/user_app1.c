      ...
      if(G_eAntApiCurrentMessageClass == ANT_DATA)
      {
        ...
        { 
          ...
          case 0:
            ...
            LCDMessage(LINE2_START_ADDR, "The heart rate:");
            LCDMessage(LINE2_START_ADDR+15, au8DataContent_Rate);
          ...
          case 3:
            ...
            LCDCommand(LCD_CLEAR_CMD);
            LCDMessage(LINE2_START_ADDR, "PID:");
            LCDMessage(LINE2_START_ADDR+5, au8DataContent_PID);  
